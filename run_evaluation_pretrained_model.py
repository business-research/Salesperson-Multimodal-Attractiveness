...
def test(dataset_name, feature_path, mode,pretrained_model_path, config_file='config/config_pretrained.json'):
    ...
    do_test(args, model, dataloader[mode], mode)
...
if __name__ == '__main__':
    ...
    for mode in ["train", "valid", "test"]:
        print(f"@@ mode: {mode}")
        test(dataset_name, feature_path, mode,pretrained_model_path)
